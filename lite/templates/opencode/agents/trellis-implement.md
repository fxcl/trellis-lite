---
description: Trellis CODE phase agent. Implements the active task's PRD — loads specs, writes code following existing patterns, runs lint/typecheck/tests. No git commit allowed.
mode: subagent
temperature: 0.2
steps: 60
permission:
